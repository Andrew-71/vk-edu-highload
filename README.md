...
Население США распределено примерно 47/29/23% между восточной, центральной, и западной частями страны по часовым поясам. Размеры вычислительных мощностей между датацентрами стоит держать примерно таким же, с дополнительными мощностями для резервирования N+1.

| Запросы                           | RPS   | ET  | CT  | PT/MT |
| --------------------------------- | ----- | --- | --- | ----- |
| Вход                              | 277   | 130 | 80  | 64    |
| Просмотр рекомендаций/предстоящих | 350   | 165 | 102 | 81    |
| Поисковый запрос                  | 580   | 273 | 168 | 133   |
| Просмотр информации о событии     | 1160  | 545 | 336 | 267   |
| Просмотр свободных мест/билетов   | 230   | 108 | 67  | 53    |
| Попытка купить билет              | 16    | 7.5 | 5   | 4     |
| Создание отзыва                   | 2.5   | 1.1 | —   | —     |
| Регистрация                       | 1     | —   | —   | —     |
...
* Взвешенный GeoDNS и Anycast обеспечивают распределение запросов между ДЦ по местоположению, загруженностью, и работоспособностью.
