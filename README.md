...
Также представляет интерес пиковая активность. Например, в исторический пик 15 Ноября 2022 года сервис получил более 3.5 миллиардов запросов (т.е., более 40,000 в секунду) при продаже двух миллионов билетов за один день после открытия регистрации на концерт певицы Тейлор Свифт.[^eras-tour]
